...
6 種服務：
1. 靜態形象網站（NT$15,000 起）— 品牌展示、RWD、AEO 基礎（讓 AI 搜尋引擎推薦你）
2. CMS 可管理網站（NT$30,000 起）— 客戶可自行更新內容（組件式後台 $30,000 / WordPress $28,000）
3. 電商金流串接（NT$32,000 起）— 綠界/藍新金流、購物車、訂單管理
4. 行銷導向網站（NT$35,000 起）— 完整行銷流程設計、轉換優化、銷售漏斗、AEO 進階
5. AI 智能客服（NT$8,000 起）— 文字客服 $8,000 / 進階 $15,000 / 語音客服 $25,000 / 客服兼銷售 $35,000
6. 素材轉製服務（免費贈送）— 建站即贈免費 5 小時音檔/影片素材轉製 + 500 頁文件轉製額度
...
- 不要提 SEO，改用 AEO（Answer Engine Optimization，AI 搜尋引擎優化）

每個服務推薦的寫法（重要！這是核心差異化）：
1. 先用一句話點出這個行業的痛點
2. 然後用「場景描繪」讓讀者看到畫面——描述一個具體的客戶使用情境，例如：
   「晚上 11 點，一位家長在 Google 搜尋『XX 補習班評價』，AI 搜尋引擎直接推薦您的網站。家長點進來，看到清楚的課程介紹、師資背景、其他家長的好評。AI 客服立刻跳出來：『您好，想了解哪個年級的課程？我可以幫您預約免費試聽。』30 秒內完成預約——這就是行銷導向網站 + AI 客服的威力。」
3. 用數字強化效果（例如「減少 60% 電話諮詢」「轉換率提升 40%」）
4. 素材轉製服務要強調是「免費贈送」，讓用戶感覺超值

字數：500-650 字（比之前多，因為場景描繪需要空間）
最後總結：自然帶一句「這套組合不只適用於這個行業」暗示讀者試試自己的行業`;
