...
const AGENTS = [
  ...
  },
  {
    ...
    reasoning: [
      ...
      {
        op: "計算",
        text: "組件式 3 年 TCO = $13.5K + 0 | WP 3 年 TCO = $15K + $18K 維護",
        cls: "indent",
      },
      {
        op: "評分",
    ...
    rec: {
      title: "推薦方案組合",
      text: "主方案：組件式後台 NT$13,500 起（7 頁 + 後台管理）\n加裝：電商模組 +NT$19,000（購物車 + 金流 + 訂單）\n加裝：Google 商家檔案 +NT$2,000\n總計 NT$34,500 起 — 涵蓋官網 + 電商 + 本地搜尋",
    },
  ...
  },
  {
    ...
    reasoning: [
      {
        op: "載入",
        text: "方案總價 = NT$34,500（組件式 $13.5K + 電商 $19K + GMB $2K）",
      },
      {
        op: "比對",
      ...
      {
        op: "計算",
        text: "相比設計公司省 $45.5K~85.5K（省 57%~71%）",
        cls: "indent",
      },
      { op: "模擬", text: "月均訂單 30 筆 × 客單價 $450 = 月營收 $13,500" },
      {
        op: "計算",
        text: "回本週期 = $34,500 ÷ $13,500 = 2.6 個月",
        cls: "indent",
      },
      {
        op: "優化",
        text: "建議分期：先上官網 $13.5K → 驗證流量 → 再加電商 $19K",
      },
      {
        op: "產出",
        text: "預算 NT$34,500 | 省 57%~71% | 2.6 個月回本",
        cls: "highlight",
      },
    ],
    confidence: [
    ...
    results: [
      { label: "總預算", value: "$34.5K", sub: "含電商加裝", color: "#2d7d5f" },
      { label: "市場省幅", value: "57%", sub: "vs 設計公司", color: "#2d7d5f" },
      { label: "回本週期", value: "2.6月", sub: "預估值", color: "#D2691E" },
      { label: "年 ROI", value: "370%", sub: "保守估計", color: "#2874a6" },
    ],
    rec: {
      title: "預算規劃建議",
      text: "第一階段（本月）：組件式官網 $13,500 → 讓 IG 流量有落地頁\n第二階段（下月）：電商加裝 $19,000 → 開始線上接單收款\n第三階段（第 3 月）：Google 商家 $2,000 → 攻佔在地搜尋\n可選加購：AI 客服 $5,000/月 → 24 小時自動回覆訂單查詢",
    },
    commOut: null,
  },
];
