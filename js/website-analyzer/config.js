...
const WebsiteAnalyzerConfig = {
  ...
  FUN_FACTS: [
    ...
    { text: "導入 AI 的企業平均節省 40% 客服人力成本" },
    { text: "AI 回覆速度不到 1 秒，客戶滿意度提升 35%" },
    { text: "24 小時不休息，凌晨的訂單也不漏接" },
    { text: "AI 語音客服能聽懂台語、客語等在地口音" },
    { text: "自動 AEO 內容每月可帶來 3-5 倍自然流量成長" },
    { text: "全球已有 67% 消費者用過 AI 客服，接受度逐年提升" },
    { text: "一套 AI 客服的月費，不到傳統客服人員日薪" },
    { text: "企業級 AI 採用 AES-256 加密，資料安全有保障" },
    { text: "AI 分析師正在掃描您的網站，找出最佳 AI 導入機會" },
  ],
